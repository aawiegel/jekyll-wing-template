...
The [code](https://github.com/aawiegel/Poochr) and [web app](https://poochr-182700.appspot.com/) are available online. This is part of a two part series where the second part can be found [here](https://aawiegel.github.io/2017/11/07/Poochr-2-Electric-Dogaloo.html).
...
This is part of a two part series where the second part can be found [here](https://aawiegel.github.io/2017/11/07/Poochr-2-Electric-Dogaloo.html).
